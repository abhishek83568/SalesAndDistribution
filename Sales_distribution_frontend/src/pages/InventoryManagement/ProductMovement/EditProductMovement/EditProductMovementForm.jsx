...
//       ? movementData.movementDate.split("T")[0] // Extract YYYY-MM-DD
//       : "",
//   }));
...
//     if (!formData.productId || !formData.inventoryId || !formData.warehouseId) {
//       alert("Product ID or inventoryId or warehouseId are required!");
//       return;
//     }
...
//           movementDate: "",
//         });
//         alert("movementData updated successfully!");
//         navigate("/productMovement");
//       } else {
//         alert(data.message || "Failed to edit movementData");
//       }
//     } catch (error) {
