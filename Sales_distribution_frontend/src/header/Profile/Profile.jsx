...
//     try {
//       const res = await fetch("http://localhost:8799/api/auth/get-user", {
//         method: "GET",
//         headers: {
...
//       if (res.ok) {
//         // If your API returns { user: { ... } }, then use data.user instead.
//         setProfile(data);
...
//   //   if (file) {
//   //     // Save the actual file object for upload
//   //     setEditedProfile((prev) => ({ ...prev, file: file }));
...
//     const file = e.target.files[0];
//     if (file) {
//       setEditedProfile((prev) => ({ ...prev, file: file })); // File for upload
//       const reader = new FileReader();
//       reader.onloadend = () => {
//         setEditedProfile((prev) => ({
//           ...prev,
...
//       // Append the actual file object (binary data)
//       formData.append("profilePic", editedProfile.file);
//     }
...
//         {editedProfile && editedProfile.profilePicture ? (
//           // <img
...
//           <img
//             src={
//               editedProfile && editedProfile.profilePic
...
const Profile = () => {
  ...
  const handleSaveClick = async (e) => {
    ...
    try {
      ...
      const data = await res.json();
      console.log("Updated Profile Response:", data); // Debugging
